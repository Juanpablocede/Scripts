SELECT
	...
	WHERE
	    ...
	    sno_fideiperiodointereses_01.mescurper=6 AND
	    sno_fideiperiodointereses_01.anocurper::INTEGER=2015) AS antiguedaanterior,
	...
	WHEN 7 THEN (	SELECT
			...
			WHERE
				...
				EXTRACT(YEAR  FROM(sno_anticipoprestaciones.fecant))= 2015)
	END AS Anticipos,
...
WHERE
	sno_fideiperiodo.anocurper='2015' AND
	sno_fideiperiodo.mescurper BETWEEN 7 AND 7 AND
