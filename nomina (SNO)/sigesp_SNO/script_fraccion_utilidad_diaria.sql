...
WHERE
	...
	sno_hsalida.codnom BETWEEN '0005' AND '0005' AND 
...
WHERE 
	...
	(sno_hsalida.codconc='0000000001' OR
	 ...
	 sno_hsalida.codconc='0000000041' OR
	 ...
	 sno_hsalida.codconc='0000003012') AND
...
--solamente debe hacerse para el mes de julio del 2013 para todas las nominas
UPDATE sno_hsalida SET
valsal=(valsal + 0.83 + (sno_fraccion_utilidad.sueldo*0.15)) --solo para el mes de julio 2013
--valsal=(0.83 + (sno_fraccion_utilidad.sueldo*0.15))
FROM
	sno_fraccion_utilidad
WHERE
	sno_hsalida.codper=sno_fraccion_utilidad.codper AND
...
otros_tiempo_viajes=COALESCE((SELECT
			...
			WHERE 
				...
				sno_constantepersonal.codnom='0005' AND
...
fraccion_utilidad_mes=(((sueldo+bono_profesionalismo+ahorro_patronal+reintegro_vacacion+
			...
			tiempo_viaje+otros_tiempo_viajes+otros_conceptos+retroactivo_utilidad))*2.31);
