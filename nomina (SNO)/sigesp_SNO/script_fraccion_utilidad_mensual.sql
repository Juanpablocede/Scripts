...
WHERE
	sno_personal01.codper=sno_hpersonalnomina.codper AND
	sno_hpersonalnomina.codnom BETWEEN '0002' AND '0002' AND
	sno_personal01.estper='1' AND
	sno_hpersonalnomina.staper BETWEEN '1' AND '2' AND
	sno_hpersonalnomina.codperi='007' 
ORDER BY
	sno_personal01.codper;
...
--Actualiza otras conceptos por diferencia RETROACTIVO TODOS pagado el mes 06/2013
...
FROM 
	sno_hsalida
WHERE 
	sno_hsalida.codnom BETWEEN '3101' AND '3101' AND 
	(sno_hsalida.codconc='0000000001' OR
	 ...
	 sno_hsalida.codconc='0000000021' OR
	 sno_hsalida.codconc='0000000022' OR
	 sno_hsalida.codconc='0000000046' OR
	 ...
	 sno_hsalida.codconc='0000310041' OR
	 sno_hsalida.codconc='0000310045' OR
...
--solamente debe hacerse para el mes de julio del 2013 para todas las nominas
UPDATE sno_fraccion_utilidad SET
retroactivo_todos=sno_fraccion_otros_montos.monto
FROM 
	sno_fraccion_otros_montos
WHERE
	sno_fraccion_utilidad.codper=sno_fraccion_otros_montos.codper;
...
valsal=sno_fraccion_utilidad.retroactivo_todos
FROM
	sno_fraccion_utilidad
WHERE
	sno_hsalida.codper=sno_fraccion_utilidad.codper AND
	sno_hsalida.codnom='0002' AND
	sno_hsalida.codperi='007' AND
...
--Actualiza otras conceptos por diferencia RETROACTIVO UTILIDAD pagado el mes 06/2013
--solamente debe hacerse para el mes de julio del 2013 para todas las nominas
DELETE FROM sno_fraccion_otros_montos;
INSERT INTO sno_fraccion_otros_montos
SELECT 
...
--solamente debe hacerse para el mes de julio del 2013 para todas las nominas
UPDATE sno_fraccion_utilidad SET
retroactivo_utilidad=sno_fraccion_otros_montos.monto
FROM 
	sno_fraccion_otros_montos
WHERE
	sno_fraccion_utilidad.codper=sno_fraccion_otros_montos.codper;
...
otros_tiempo_viajes=COALESCE((SELECT
			...
			WHERE 
				...
				sno_constantepersonal.codnom='0002' AND
...
fraccion_utilidad_mes=(((sueldo+bono_profesionalismo+ahorro_patronal+reintegro_vacacion+
			...
			tiempo_viaje+otros_tiempo_viajes+otros_conceptos+retroactivo_utilidad)/30)*10);
...
WHERE
	...
	sno_hpersonalnomina.codnom='0002' AND
	sno_hpersonalnomina.codperi='007' */
