...
SELECT
	...
	(SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 1 ELSE MAX(porc_diciembre/100)+1 END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
...
SELECT
	...
	(SUM(sno_salida.valsal)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 1 ELSE MAX(porc_febrero/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_enero/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_febrero/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_marzo/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_abril/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_mayo/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_junio/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_julio/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_agosto/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_septiembre/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_octubre/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_noviembre/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
	...
	(SUM(sno_salida.valsal)+SUM(sno_salida.valsal)*
		...
		WHERE 
			...
			sno_salida.codconc=sfp_aplica_concepto_formulacion.codconc)*
		(SELECT 
			CASE COUNT(*) WHEN 0 THEN 0 ELSE MAX(porc_diciembre/100) END
		FROM 
			sfp_aplica_concepto_formulacion 
		WHERE 
			ano_presupuesto=2018 AND 
