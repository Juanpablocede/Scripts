...
FROM
	...
	sfp_estpro5
WHERE
	spe_int_arts.codart=soc_servicios.codser AND
	soc_servicios.codunimed=siv_unidadmedida.codunimed AND
	spe_int_arts.codinte=spe_relacion_es.codinte AND

	spe_relacion_es.codestpro1='0000000000000000000000008' AND
